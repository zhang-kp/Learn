package com.zkp.easyexcel;

import com.alibaba.excel.EasyExcelFactory;
import com.alibaba.excel.ExcelWriter;
import com.zkp.easyexcel.model.WriteModel;
import com.zkp.easyexcel.model.WriteModel2;
import com.zkp.easyexcel.util.DataUtil;
...
public class EasyExcelApplicationTests {
    ...
    public void writeExcel1() throws Exception {
        // 文件输出位置
        OutputStream out = new FileOutputStream("E:/test/test.xlsx");
    ...
    public void writeExcel2() throws Exception {
        // 文件输出位置
        OutputStream out = new FileOutputStream("E:/test/test2.xlsx");
...
//        table1.setTableStyle(DataUtil.createTableStyle());
    ...
    public void writeChongqingExcel() throws Exception {
        OutputStream out = new FileOutputStream("E:/test/chongqing.xlsx");
        ExcelWriter writer = EasyExcelFactory.getWriter(out);
